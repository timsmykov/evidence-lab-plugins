---
name: research-core-critic
description: Adversarial reviewer for research-core artefacts. Use after the work is complete to find unsupported claims, missing decisions, routing mistakes, and reproducibility failures before handoff.
