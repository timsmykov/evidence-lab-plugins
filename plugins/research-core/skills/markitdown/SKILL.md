---
name: markitdown
description: Convert heterogeneous documents and selected URIs to Markdown with Microsoft MarkItDown for text analysis, search, and LLM/RAG ingestion. Use when a supported PDF, Office, data, archive, audio, or web source must become normalized Markdown; use writing-skill only when the task is to author or revise prose.
license: MIT
metadata:
  version: "2.1"
