...
|---|---|---:|---:|---|---|---|
| `evidence-lab-core` | `core` | `0.15.0` | 5 | `onboarding`, `pack-selection`, `companion-plugin-planning`, `installation-lifecycle`, `personal-skill-authoring`, `paper-lookup`, `citation-management`, `critical-thinking` | always | `draft` |
...
| `evidence-lab-core` | `evidence-lab-onboarding` | `onboarding` | 149 | 6 | 1 | yes | `needs-representative-testing` |
