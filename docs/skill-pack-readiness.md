...
|---|---|---:|---:|---|---|---|
| `evidence-lab-core` | `core` | `0.14.0` | 5 | `onboarding`, `pack-selection`, `companion-plugin-planning`, `installation-lifecycle`, `personal-skill-authoring`, `paper-lookup`, `citation-management`, `critical-thinking` | always | `draft` |
