...
### Changed
- Recorded the compatibility router quality status without changing dependency routing.
...
### Added
- Initial workflow pack decomposed from the former research-core bundle.
